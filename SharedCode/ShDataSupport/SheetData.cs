...
namespace SharedCode.ShDataSupport
{
	...
	public class SheetConfig
	{
		...
		private static Tuple<SheetBorderType, string, string>[] shtTypeNames1 = new []
		{
			...
			new Tuple<SheetBorderType, string, string>(ST_XX_8_5X11,             "XX-8.5x11" ,"XX 8.5x11 Sheet" ),
			new Tuple<SheetBorderType, string, string>(ST_AO_30X42,              "AO-30x42-Resi" , "AO 30x42 Sheet Residential" ),
		};
		...
		private static void setSheetZones()
		{
			...
			// alternate sheet configuration 1 - 11X17
			boxes = new Dictionary<BoxZone, BoxZoneData>();
			...
			// alternate sheet configuration 2 - 8.5x11
			boxes = new Dictionary<BoxZone, BoxZoneData>();

			boxes.Add(SZD_SHT_CONTENT_MARGINS,    getZoneData(SZ_NA, ZA_NA, new [] {0f, 0f, 0f, 0f}));
			// box data                           
			boxes.Add(SZD_BANNER_BR_VERT_BOX,     getZoneData(SZ_SHT_RECT, ZA_BL, new [] {0.25f, 0.10f, 2.74f, 0.15f}));
			boxes.Add(SZD_BANNER_BR_HORIZ_BOX,    getZoneData(SZ_SHT_RECT, ZA_BL, new [] {0.11f, 0.35f, 0.15f, 2.74f}));
			boxes.Add(SZD_BANNER_TR_VERT_BOX,     getZoneData(SZ_SHT_RECT, ZA_BL, new [] {5.52f, 0.10f, 2.74f, 0.15f}));
			boxes.Add(SZD_BANNER_TR_HORIZ_BOX,    getZoneData(SZ_SHT_RECT, ZA_BL, new [] {8.25f, 0.34f, 0.15f, 2.74f}));
			boxes.Add(SZD_FOOTER_BOX,             getZoneData(SZ_SHT_RECT, ZA_BL, new [] {0.08f, 9.18f, 0.10f, 1.70f}));
			boxes.Add(SZD_DISCLAIMER_BOX,         getZoneData(SZ_SHT_RECT, ZA_BL, new [] {5.52f, 10.66f, 2.75f, 0.17f}));
			boxes.Add(SZD_PRIME_AUTHOR_BOX,       getZoneData(SZ_SHT_RECT, ZA_BL, new [] {6.53f, 0.38f, 1.53f, 2.18f}));
			boxes.Add(SZD_SHT_NUM_W_PKG_LINK_BOX, getZoneData(SZ_NA, ZA_NA, new [] {0f, 0f, 0f, 0f}));
			boxes.Add(SZD_SHT_NUM_W_PKG_FIND_BOX, getZoneData(SZ_NA, ZA_NA, new [] {0f, 0f, 0f, 0f}));
			boxes.Add(SZD_SHT_NUM_NOPKG_LINK_BOX, getZoneData(SZ_SHT_RECT, ZA_BL, new [] {0.38f, 0.36f, 1.7f, 2.25f}));
			boxes.Add(SZD_SHT_NUM_NOPKG_FIND_BOX, getZoneData(SZ_SHT_RECT, ZA_BL, new [] {0.38f, 0.36f, 1.7f, 2.25f}));

			BoxZones.Add(ST_XX_COMMON, boxes);
			...
			boxes = new Dictionary<BoxZone, BoxZoneData>();
			//                                                                     L      T      R      B
			boxes.Add(SZD_SHT_MARGINS, getZoneData(SZ_SHT_RECT, ZA_BL, new [] { 0.100f, 0.100f, 0.100f, 0.100f }));
			BoxZones.Add(ST_XX_8_5X11, boxes);
			...
			sheetRect = new float[] { 0f, 0f, 11.00f, 8.50f };
			ttlBlkRect = new float[] { 0.05f, 0.05f, 8.00f, 0.5f };

			makeZones(ST_XX_8_5X11, ST_XX_COMMON,
				sheetRect,
				ttlBlkRect,
				SZD_SHT_NUM_NOPKG_FIND_BOX,
				SZD_SHT_NUM_NOPKG_LINK_BOX
...
// 		
		...
		private static void showSheetData(SheetBorderType borderType)
		{
			...
			string m = FormatItextData.FormatFloatArray(
