...
public static class PdfShowInfo
{
	...
	public static void showSinAndCos()
	{
		...
		Debug.WriteLine("\nfloat MathF");
		Debug.WriteLine($"for angle {0,5:F0} | sin {MathF.Sin(FloatOps.ToRad(0)),6:F0} cos {MathF.Cos(FloatOps.ToRad(0)),6:F0}");
		Debug.WriteLine($"for angle {90,5:F0} | sin {MathF.Sin(FloatOps.ToRad(90)),6:F0} cos {MathF.Cos(FloatOps.ToRad(90)),6:F0}");
		Debug.WriteLine($"for angle {180,5:F0} | sin {MathF.Sin(FloatOps.ToRad(180)),6:F0} cos {MathF.Cos(FloatOps.ToRad(180)),6:F0}");
		Debug.WriteLine($"for angle {270,5:F0} | sin {MathF.Sin(FloatOps.ToRad(270)),6:F0} cos {MathF.Cos(FloatOps.ToRad(270)),6:F0}");
