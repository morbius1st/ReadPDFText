...
#region FILE PATH UTILS
	...
	#region public static methods
		...
		/// </summary>
		public static string AssembleFilePathString(string driveLetter, string fileNameNoExt, string extensionNoSep, params string[] folderList)
		{
			if (fileNameNoExt.IsVoid() && extensionNoSep.IsVoid() && driveLetter.IsVoid() && folderList == null) return null;
